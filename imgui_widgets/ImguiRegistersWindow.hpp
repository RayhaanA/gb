...
struct RegistersWindow {
    ...
    void drawWindow(CPU& cpu) {
        ...
        ImGui::Text("PC"); ImGui::NextColumn(); ImGui::Separator();
        formatBase(cpu.getPC(), base); ImGui::NextColumn();
        formatBase(cpu.getPCPrev(), base); ImGui::NextColumn();

        ImGui::Text("SP"); ImGui::NextColumn(); ImGui::Separator();
        formatBase(cpu.getSP(), base); ImGui::NextColumn();
        formatBase(cpu.getSPPrev(), base); ImGui::NextColumn();

        ImGui::Text("AF"); ImGui::NextColumn(); ImGui::Separator();
        formatBase(cpu.getAF(), base); ImGui::NextColumn();
        formatBase(cpu.getAFPrev(), base); ImGui::NextColumn();

        ImGui::Text("BC"); ImGui::NextColumn(); ImGui::Separator();
        formatBase(cpu.getBC(), base); ImGui::NextColumn();
        formatBase(cpu.getBCPrev(), base); ImGui::NextColumn();

        ImGui::Text("DE"); ImGui::NextColumn(); ImGui::Separator();
        formatBase(cpu.getDE(), base); ImGui::NextColumn();
        formatBase(cpu.getDEPrev(), base); ImGui::NextColumn();

        ImGui::Text("HL"); ImGui::NextColumn(); ImGui::Separator();
        formatBase(cpu.getHL(), base); ImGui::NextColumn();
        formatBase(cpu.getHLPrev(), base); ImGui::NextColumn();

        ImGui::Text("IF"); ImGui::NextColumn(); ImGui::Separator();
        formatBase(cpu.getIF(), base); ImGui::NextColumn();
        formatBase(cpu.getIFPrev(), base); ImGui::NextColumn();

        ImGui::Text("IE"); ImGui::NextColumn(); ImGui::Separator();
        formatBase(cpu.getIE(), base); ImGui::NextColumn();
        formatBase(cpu.getIEPrev(), base); ImGui::NextColumn();
